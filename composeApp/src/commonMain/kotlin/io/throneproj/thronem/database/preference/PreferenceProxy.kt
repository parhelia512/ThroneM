package io.throneproj.thronem.database.preference
...
import io.throneproj.thronem.database.callingUserIndex
import io.throneproj.thronem.ktx.parsePort
...
class PreferenceProxy<T> internal constructor(
     ...
     * [io.throneproj.thronem.database.DataStore.currentGroupId]).
     */
