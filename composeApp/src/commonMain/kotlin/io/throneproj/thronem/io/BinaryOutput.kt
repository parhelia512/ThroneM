package io.throneproj.thronem.io

import io.throneproj.thronem.io.BinaryFormat.ASCII_MAX_CHAR
import io.throneproj.thronem.io.BinaryFormat.ASCII_MAX_LENGTH
import io.throneproj.thronem.io.BinaryFormat.ASCII_MIN_LENGTH
import io.throneproj.thronem.io.BinaryFormat.ASCII_TERMINATOR_BIT
import io.throneproj.thronem.io.BinaryFormat.EMPTY_STRING
import io.throneproj.thronem.io.BinaryFormat.NULL_STRING
import io.throneproj.thronem.io.BinaryFormat.UTF8_CONTINUATION_MASK
import io.throneproj.thronem.io.BinaryFormat.UTF8_CONTINUATION_PREFIX
import io.throneproj.thronem.io.BinaryFormat.UTF8_ONE_BYTE_MAX
import io.throneproj.thronem.io.BinaryFormat.UTF8_THREE_BYTE_PAYLOAD_MASK
import io.throneproj.thronem.io.BinaryFormat.UTF8_THREE_BYTE_PREFIX
import io.throneproj.thronem.io.BinaryFormat.UTF8_TWO_BYTE_MAX
import io.throneproj.thronem.io.BinaryFormat.UTF8_TWO_BYTE_PAYLOAD_MASK
import io.throneproj.thronem.io.BinaryFormat.UTF8_TWO_BYTE_PREFIX
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_CONTINUATION_BIT
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_FLAG_BIT
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_FLAG_CONTINUATION_BIT
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_FLAG_FIRST_SHIFT
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_FLAG_PAYLOAD_MASK
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_PAYLOAD_BITS
import io.throneproj.thronem.io.BinaryFormat.VAR_INT_PAYLOAD_MASK
import okio.Buffer
