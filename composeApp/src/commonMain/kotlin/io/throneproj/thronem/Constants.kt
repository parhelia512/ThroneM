...
object Key {
    ...
    const val DB_PROFILE = "thronem.db"
    ...
    // WARP wizard
    const val WARP_ACCOUNT = "warpAccount"
    const val MASQUE_ACCOUNT = "masqueAccount"
    ...
    const val PROXY_SET_ID = "proxySetId"
...
object Action {
    const val SERVICE = "io.throneproj.thronem.SERVICE"
    const val CLOSE = "io.throneproj.thronem.CLOSE"
    const val RELOAD = "io.throneproj.thronem.RELOAD"

    // const val SWITCH_WAKE_LOCK = "io.throneproj.thronem.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "io.throneproj.thronem.RESET_UPSTREAM_CONNECTIONS"
}
