...
import io.throneproj.thronem.resources.backup_groups_and_configurations
import io.throneproj.thronem.resources.backup_import
import io.throneproj.thronem.resources.backup_import_summary
import io.throneproj.thronem.resources.backup_rules
import io.throneproj.thronem.resources.backup_settings
import io.throneproj.thronem.resources.backup_summary
...
internal fun BackupScreen(
    ...
    LaunchedEffect(uiState.exported) {
        uiState.exported?.let {
            ...
            val fileName = "thronem_backup_${time}"
