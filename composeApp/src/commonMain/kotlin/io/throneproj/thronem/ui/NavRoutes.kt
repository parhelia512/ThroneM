...
sealed class NavRoutes : NavKey {
            ...
            get() = SavedStateConfiguration {
                serializersModule = SerializersModule {
                    polymorphic(NavKey::class) {
                        ...
                        subclass(ProxySets::class, ProxySets.serializer())
                        subclass(ProxySetSettings::class, ProxySetSettings.serializer())
                        ...
                        subclass(WarpWizard::class, WarpWizard.serializer())
    ...
    @Serializable
    data object ProxySets : NavRoutes()

    @Serializable
    data class ProxySetSettings(
        val setId: Long = 0L,
    ) : NavRoutes()
    ...
    @Serializable
    data object WarpWizard : NavRoutes()
