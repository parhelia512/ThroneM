...
import io.throneproj.thronem.compose.material3.ButtonDefaults
import io.throneproj.thronem.compose.material3.Card
...
import io.throneproj.thronem.resources.latency
import io.throneproj.thronem.resources.nat_address_and_port_dependent
import io.throneproj.thronem.resources.nat_address_dependent
import io.throneproj.thronem.resources.nat_endpoint_independent
import io.throneproj.thronem.resources.nat_external_address
import io.throneproj.thronem.resources.nat_filtering
import io.throneproj.thronem.resources.nat_mapping
import io.throneproj.thronem.resources.nat_result_hint
import io.throneproj.thronem.resources.nat_stun_server_hint
import io.throneproj.thronem.resources.nat_type_detection
import io.throneproj.thronem.resources.nat_type_not_supported
import io.throneproj.thronem.resources.nat_unknown
import io.throneproj.thronem.resources.start
import io.throneproj.thronem.resources.stun_attest_loading
...
internal fun StunScreen(
    ...
    val serviceConnected = serviceStatus.state.connected
                ...
                if (uiState.isDoing) {
                    ...
                    Button(
                        onClick = {
                            ...
                            viewModel.doTest(serviceConnected)
                        },
                        modifier = Modifier.padding(horizontal = 24.dp),
                    ) {
