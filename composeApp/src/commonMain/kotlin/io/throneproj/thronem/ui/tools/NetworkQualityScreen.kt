...
import io.throneproj.thronem.core.NetworkQualityPhase
...
import io.throneproj.thronem.resources.download_capacity
import io.throneproj.thronem.resources.download_responsiveness
import io.throneproj.thronem.resources.elapsed_time
import io.throneproj.thronem.resources.error
import io.throneproj.thronem.resources.error_title
import io.throneproj.thronem.resources.idle_latency
import io.throneproj.thronem.resources.network_quality_config_url
import io.throneproj.thronem.resources.network_quality_http3
import io.throneproj.thronem.resources.network_quality_max_runtime
import io.throneproj.thronem.resources.network_quality_serial
import io.throneproj.thronem.resources.network_quality_test
import io.throneproj.thronem.resources.ok
import io.throneproj.thronem.resources.responsiveness_rpm
import io.throneproj.thronem.resources.speed
import io.throneproj.thronem.resources.start
import io.throneproj.thronem.resources.upload_capacity
import io.throneproj.thronem.resources.upload_responsiveness
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                if (uiState.canTest) {
                    Button(onClick = { viewModel.doTest(serviceConnected) }) {
    ...
    Column(
        ...
        ReportLine(
            ...
            value = report.downloadCapacity
                ...
                ?.let { stringResource(Res.string.speed, Libbox.formatBytes(it)) },
        )
        HorizontalDivider(modifier = Modifier.fillMaxWidth())
        ReportLine(
