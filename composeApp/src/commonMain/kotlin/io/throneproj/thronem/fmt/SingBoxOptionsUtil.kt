...
import io.throneproj.thronem.fmt.SingBoxOptions.NewDNSServerOptions
import io.throneproj.thronem.fmt.SingBoxOptions.NewDNSServerOptions_LocalDNSServerOptions
import io.throneproj.thronem.fmt.SingBoxOptions.NewDNSServerOptions_RemoteDNSServerOptions
import io.throneproj.thronem.fmt.SingBoxOptions.NewDNSServerOptions_RemoteHTTPSDNSServerOptions
import io.throneproj.thronem.fmt.SingBoxOptions.NewDNSServerOptions_RemoteTLSDNSServerOptions
import io.throneproj.thronem.fmt.SingBoxOptions.OutboundTLSOptions
import io.throneproj.thronem.fmt.SingBoxOptions.RuleSet_Local
import io.throneproj.thronem.fmt.SingBoxOptions.RuleSet_Remote
...
fun buildDNSServer(
    ...
    val url = if (!link.contains("://")) {
        newURL(SingBoxOptions.DNS_TYPE_UDP).apply {
            fullHost = link
        }
    } else {
        parseURL(link)
