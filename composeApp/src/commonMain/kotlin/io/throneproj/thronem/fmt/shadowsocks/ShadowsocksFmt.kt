package io.throneproj.thronem.fmt.shadowsocks
...
import io.throneproj.thronem.ktx.substringBetween
...
fun parseShadowsocks(rawUrl: String): ShadowsocksBean {
    ...
    var url = parseURL(fixedURL)
    if (url.username.isBlank()) { // fix justmysocks' non-standard link
        url = parseURL(fixedURL.substringBefore("#").b64DecodeToString())
