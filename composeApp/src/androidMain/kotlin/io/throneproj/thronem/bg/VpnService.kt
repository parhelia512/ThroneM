...
import io.throneproj.thronem.resources.reboot_required
import io.throneproj.thronem.ui.VpnRequestActivity
import io.throneproj.thronem.utils.Subnet
...
class VpnService : BaseVpnService(),
    ...
    override fun acquireWakeLock() {
        wakeLock = resolveAndroidRepository().power.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "thronem:vpn")
            .apply { acquire() }
    }
